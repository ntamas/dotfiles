# Generated by Powerlevel10k configuration wizard on 2019-09-27 at 09:16 CEST.
...
() {
  ...
  # Tagicon. Set this parameter to '\uF126 ' for the popular Powerline branch icon.
  ...
  # '#tag' if on a tag.
  vcs+='${${VCS_STATUS_TAG:+ %76F'${(g::)POWERLEVEL9K_VCS_TAG_ICON}'${VCS_STATUS_TAG//\%/%%}}}'
